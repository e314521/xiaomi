...
exports.main = async (event, context) => {
	try {
		...
		//url = "https://8fd96c49-f69a-47c7-84cc-7fb432364c6a.bspapp.com/xiaomi"
		var headers = {
		...
		var login_token = res.data.token_info.login_token
		var userid = res.data.token_info.user_id
		...
		var app_token = res.data.token_info.app_token
		let d = new Date(new Date().getTime() + 3600000 * 8 + new Date().getTimezoneOffset()*60000)
		let yy = d.getFullYear()
		let mm = (d.getMonth() + 1) < 10 ? '0' + (d.getMonth() + 1) : (d.getMonth() +
			1)
		...
		console.log(date)
		data_json = data_json.replace("2020-08-14", date)
		data_json = data_json.replace("ttl%5C%22%3A125%2C%5C%22dis", "ttl%5C%22%3A" + steps +
			"%2C%5C%22dis")
		data = 'userid=' + userid + '&last_sync_data_time=' + parseInt(new Date().getTime() / 1000) +
			'&device_type=0&last_deviceid=DA932FFFFE8816E7&data_json=' + data_json
	...
	//console.log(login_token,userid,app_token)
	//res.headers.location.match()
	//返回数据给客户端
	return ""
};
